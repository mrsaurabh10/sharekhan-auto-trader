...
class ShoonyaQuoteServiceTest {
    ...
    @Test
    void postsUidExchangeAndTokenToGetQuotesWithBearerAccessToken() throws Exception {
        ...
        properties.setUid("FA12345");
        JSONObject result = new ShoonyaQuoteService(properties, tokens,
        ...
        assertThat(authorization.get()).isEqualTo("Bearer session-token");
    }
